...
本篇[云框架](ABOUT.md)将以一个自建FaaS平台www.faas.pro及两个应用[ETCD_v3](https://github.com/cloudframeworks-functionservice/function-example/tree/master/etcd_v3)、[推文获取应用](https://github.com/cloudframeworks-functionservice/function-example/tree/master/twitter)为例介绍FaaS／Serverless及其最佳实践。
